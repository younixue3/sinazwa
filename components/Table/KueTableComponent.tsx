  ...
  const filteredData = useMemo(() => {
    ...
    return data.data.filter((item: any) => {
      ...
      return (
        ...
        item.category_cake_id?.toString().includes(searchLower) ||
        item.price?.toString().includes(searchLower) ||
        item.box?.toString().includes(searchLower) ||
        ...
        <div className="bg-white dark:bg-gray-900 p-4">
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              placeholder="Cari berdasarkan nama, deskripsi, ID, kategori, harga, box, atau qty..."
            />
          </div>
