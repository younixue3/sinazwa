...
import { CreateAdjustment } from 'components/Pages/delivery/kue-rusak/CreateAdjustment';
...
export default function Penyesuaian() {
  ...
  const filteredCakes = brokenCakes?.filter(cake => {
    ...
    return (
      cake.quantity_adjustment && // Only include cakes with quantity_adjustment
          ...
          {isLoading ? (
            ...
            <CardComponent>
              <div className="text-center text-gray-600 py-4">
                Tidak ada data penyesuaian ditemukan
              </div>
            </CardComponent>
          ) : (
              ...
              <CardComponent key={cake.id}>
                <div className="flex flex-col gap-3 p-4 bg-gradient-to-br from-white to-gray-50 rounded-lg shadow-sm">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-700">Kue Penyesuaian:</span>
                    <span className="font-semibold text-amber-500 bg-red-50 px-3 py-1 rounded-full">
                      {cake.quantity_adjustment}
                    </span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
